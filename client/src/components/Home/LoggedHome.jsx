        ...
        <div className='w-[90%] h-140 min-h-93 bg-[#121212] rounded-4xl mb-[10vh] flex flex-col items-center mt-5 px-[3vw] py-[2vw] gap-4'>
            <div className='w-full h-2/3 flex flex-col items-center justify-center gap-10 '>
                ...
                <div className='w-9/10 flex gap-4 items-center justify-center text-[4vw] md:text-3xl'>
                    <Link to="/track" className='bg-white text-[#121212] px-[2vw] py-[0.5vh] rounded-3xl font-roboto-condensed hover:bg-green-400 transition duration-300'>Track</Link>
                    <Link to="/todays-update" className='bg-white text-[#121212] px-[2vw] py-[0.5vh] rounded-3xl font-roboto-condensed transition duration-300 hover:bg-green-400 '>Today's Update</Link>
                </div>
            </div>
